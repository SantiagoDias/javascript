let smlv=parseFloat(prompt("Ingrese salario mínimo legal vigente año 2022"));
 let subtte=parseFloat(prompt("Ingrese subsidio transporte año 2022"));
        function liquidar(){
            //SUELDO BÁSICO
            let n1=document.getElementById("salario").value;// bajar inf del form al vscode
            let n2=document.getElementById("dias").value;// bajar info del form vscode
            Sueldo=parseInt(n1)/30*parseInt(n2);
            document.getElementById("basico").value=Sueldo.toFixed(0);
            //subiir del vs code al form
            //SUBSIDIO TRANSPORTE
            if (n1>=2*smlv){
